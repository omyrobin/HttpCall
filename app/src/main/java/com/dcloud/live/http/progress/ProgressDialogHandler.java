...
public class ProgressDialogHandler extends Handler {
    ...
    public ProgressDialogHandler(Context context, ProgressCancelListener mProgressCancelListener, boolean outSizeCancelable) {
        super();
    ...
    private void create(){
        if (dialog == null) {
            ...
            View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_custom_load, null);
